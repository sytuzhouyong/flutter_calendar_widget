...
int lastDayOffset(int year, int month, MaterialLocalizations localizations) {
  // 0-based day of week for the month and year, with 0 representing Monday.
  int daysInMonth = getDaysInMonth(year, month);
  final int firstOffset = firstDayOffset(year, month, localizations);
  final int lastOffset = (firstOffset + daysInMonth) % 7;
  return lastOffset;
}
